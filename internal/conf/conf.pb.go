...
type Data struct {
	...
	RedisCache *Data_RedisCache `protobuf:"bytes,3,opt,name=redis_cache,json=redisCache,proto3" json:"redis_cache,omitempty"`
}
...
func (x *Data) GetRedisCache() *Data_RedisCache {
	if x != nil {
		return x.RedisCache
	}
	return nil
...
type Data_RedisCache struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Addrs    map[string]string `protobuf:"bytes,1,rep,name=addrs,proto3" json:"addrs,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Username string            `protobuf:"bytes,2,opt,name=username,proto3" json:"username,omitempty"`
	Password string            `protobuf:"bytes,3,opt,name=password,proto3" json:"password,omitempty"`
	Db       int32             `protobuf:"varint,4,opt,name=db,proto3" json:"db,omitempty"`
}

func (x *Data_RedisCache) Reset() {
	*x = Data_RedisCache{}
	if protoimpl.UnsafeEnabled {
...
func (x *Data_RedisCache) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_RedisCache) ProtoMessage() {}

func (x *Data_RedisCache) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_RedisCache.ProtoReflect.Descriptor instead.
func (*Data_RedisCache) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{2, 2}
}

func (x *Data_RedisCache) GetAddrs() map[string]string {
	if x != nil {
		return x.Addrs
	}
	return nil
...
func (x *Data_RedisCache) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *Data_RedisCache) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
func (x *Data_RedisCache) GetDb() int32 {
	if x != nil {
		return x.Db
	}
	return 0
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0xd4, 0x05, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a, 0x08, 0x64, 0x61,
	...
	0x3c, 0x0a, 0x0b, 0x72, 0x65, 0x64, 0x69, 0x73, 0x5f, 0x63, 0x61, 0x63, 0x68, 0x65, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x2e, 0x52, 0x65, 0x64, 0x69, 0x73, 0x43, 0x61, 0x63, 0x68,
	0x65, 0x52, 0x0a, 0x72, 0x65, 0x64, 0x69, 0x73, 0x43, 0x61, 0x63, 0x68, 0x65, 0x1a, 0x3a, 0x0a,
	...
	0x61, 0x6c, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x1a, 0xcc, 0x01, 0x0a, 0x0a, 0x52, 0x65,
	0x64, 0x69, 0x73, 0x43, 0x61, 0x63, 0x68, 0x65, 0x12, 0x3c, 0x0a, 0x05, 0x61, 0x64, 0x64, 0x72,
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73,
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x2e, 0x52, 0x65, 0x64, 0x69, 0x73, 0x43,
	0x61, 0x63, 0x68, 0x65, 0x2e, 0x41, 0x64, 0x64, 0x72, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52,
	0x05, 0x61, 0x64, 0x64, 0x72, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61,
	...
	,
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Data_RedisCache)(nil),     // 8: kratos.api.Data.RedisCache
	nil,                         // 9: kratos.api.Data.RedisCache.AddrsEntry
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	8,  // 7: kratos.api.Data.redis_cache:type_name -> kratos.api.Data.RedisCache
	...
	9,  // 13: kratos.api.Data.RedisCache.addrs:type_name -> kratos.api.Data.RedisCache.AddrsEntry
